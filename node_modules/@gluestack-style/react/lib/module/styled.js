    ...
    componentStyleConfig.resolveProps.forEach(toBeResovledProp => {
      if (props[toBeResovledProp]) {
        ...
        if (CONFIG.propertyResolver && CONFIG.propertyResolver.props && CONFIG.propertyResolver.props[toBeResovledProp]) {
          ...
          //@ts-ignore
          resolvedInlineProps[toBeResovledProp] = getResolvedTokenValueFromConfig(componentExtendedConfig, props, toBeResovledProp, props[toBeResovledProp]);
        }
...
export function verboseStyled(Component, theme) {
  ...
  if (BUILD_TIME_PARAMS !== null && BUILD_TIME_PARAMS !== void 0 && BUILD_TIME_PARAMS.orderedResolved) {
    ...
    const {
      styledIds: g,
      verbosedStyleIds
    } = updateOrderUnResolvedMap(theme, componentHash, declarationType, componentStyleConfig);
    orderedCSSIds = g;
  ...
  function injectSx(sx) {
    ...
    injectComponentAndDescendantStyles(orderedSXResolved, sxHash, type, GluestackStyleSheet, Platform.OS, inlineStyleMap);
  ...
  const StyledComponent = (_ref, ref) => {
    ...
    if (!styleHashCreated) {
      ...
      if (EXTENDED_THEME) {
        ...
        if (Object.keys((EXTENDED_THEME === null || EXTENDED_THEME === void 0 ? void 0 : EXTENDED_THEME.BUILD_TIME_PARAMS) ?? {}).length > 0) {
          ...
          const extendedStylesToBeInjected = GluestackStyleSheet.resolve(resolvedComponentExtendedTheme === null || resolvedComponentExtendedTheme === void 0 ? void 0 : resolvedComponentExtendedTheme.styledIds, CONFIG, componentExtendedConfig);
      ...
      if (plugins) {
        for (const pluginName in plugins) {
          ...
          // @ts-ignore
          [nonVerbosedTheme,,, Component] = (_plugins$pluginName = plugins[pluginName]) === null || _plugins$pluginName === void 0 ? void 0 : _plugins$pluginName.inputMiddleWare(nonVerbosedTheme, true, true, Component, componentStyleConfig, ExtendedConfig);
        }
      ...
      if (!BUILD_TIME_PARAMS || !(BUILD_TIME_PARAMS !== null && BUILD_TIME_PARAMS !== void 0 && BUILD_TIME_PARAMS.orderedResolved) || (BUILD_TIME_PARAMS === null || BUILD_TIME_PARAMS === void 0 ? void 0 : BUILD_TIME_PARAMS.orderedResolved.length) === 0) {
        const toBeInjected = GluestackStyleSheet.resolve(orderedCSSIds, CONFIG, componentExtendedConfig);
        if (Platform.OS === 'web') {
    ...
    inlineComponentPropsWithoutVariants, styledSystemProps, componentStyleConfig, reservedKeys);
    let {
      sx: filteredPassingSx,
      rest: filteredPassingRemainingProps
    } = convertUtiltiyToSXFromProps(shallowMerge({
      ...defaultThemePropsWithoutVariants,
      ...passingProps
    }, applyAncestorPassingProps), styledSystemProps, componentStyleConfig, reservedKeys);
    ...
    if (containsSX) {
      ...
      if (Object.keys(applySxStatePassingProps.current).length > 0 || Object.keys(sxComponentPassingProps.current).length > 0) {
        ...
        } = convertUtiltiyToSXFromProps(passingPropsUpdated, styledSystemProps, componentStyleConfig, reservedKeys);
    ...
    const resolvedStyleProps = generateStylePropsFromCSSIds(applyComponentInlineProps, styleCSSIds, CONFIG, activeTheme, componentConfig);

    // const AsComp: any = React.useRef(
    //   resolvedStyleProps.as || (passingProps.as as any) || undefined
    // ).current;

    const AsComp = React.useMemo(() => {
    ...
    if (AsComp) {
      ...
      if (Component.isStyledComponent) {
        component = /*#__PURE__*/React.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, variantProps, propsToBePassedInToPlugin, {
          states: states,
        ...
        component = /*#__PURE__*/React.createElement(AsComp, _extends({}, resolvedStyleProps, {
          style: resolvedStyleMemo,
          ref: ref
        }));
      }
      ...
      //@ts-ignores
      component = Component.isStyledComponent ? /*#__PURE__*/React.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, propsToBePassedInToPlugin, variantProps, {
        states: states,
        style: resolvedStyleMemo,
        ref: ref
      })) : /*#__PURE__*/React.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, propsToBePassedInToPlugin, {
        style: resolvedStyleMemo,
        ref: ref
      }));
    }
