...
// base
'boot-base', 'extended-base', 'boot-base-state', 'extended-base-state',
// descendant-base
'boot-descendant-base', 'extended-descendant-base', 'boot-descendant-base-state', 'extended-descendant-base-state',
// variant
'boot-variant', 'extended-variant', 'boot-variant-state', 'extended-variant-state',
// descendant-variant
'boot-descendant-variant', 'extended-descendant-variant', 'boot-descendant-variant-state', 'extended-descendant-variant-state',
// inline
  ...
  if (typeof window !== 'undefined') {
    ...
    if (wrapperElement) {
      ...
      if (!style) {
        ...
        if (inlineStyleMap) {
          if (!(inlineStyleMap !== null && inlineStyleMap !== void 0 && inlineStyleMap.initialStyleInjected)) {
...
export const injectGlobalCss = function (css) {
