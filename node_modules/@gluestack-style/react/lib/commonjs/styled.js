...
function convertUtiltiyToSXFromProps(componentProps, styledSystemProps, componentStyleConfig) {
  ...
  const resolvedSxVerbose = (0, _utils.deepMergeObjects)(utilityResolvedSX, userSX);
...
function verboseStyled(Component, theme) {
  ...
  const StyledComponent = (_ref, ref) => {
    ...
    const resolvedStyleProps = (0, _generateStylePropsFromCSSIds.generateStylePropsFromCSSIds)(applyComponentInlineProps, styleCSSIds, CONFIG, activeTheme, componentConfig);

    // const AsComp: any = React.useRef(
    //   resolvedStyleProps.as || (passingProps.as as any) || undefined
    // ).current;

    const AsComp = _react.default.useMemo(() => {
    ...
    if (AsComp) {
      ...
      if (Component.isStyledComponent) {
        component = /*#__PURE__*/_react.default.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, variantProps, propsToBePassedInToPlugin, {
          states: states,
      ...
      //@ts-ignores
      component = Component.isStyledComponent ? /*#__PURE__*/_react.default.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, propsToBePassedInToPlugin, variantProps, {
        states: states,
        style: resolvedStyleMemo,
        ref: ref
      })) : /*#__PURE__*/_react.default.createElement(ComponentWithPlugin, _extends({}, resolvedStyleProps, propsToBePassedInToPlugin, {
        style: resolvedStyleMemo,
        ref: ref
      }));
    }
