  ...
  Object.keys(stylesObject).map(key => {
    ...
    if (themeCondition) {
      Object.keys(themeCondition).forEach(themeName => {
        ...
        themeCssObj[themeName] = (0, _createDeclarationBlock.default)(themeConditionValue);
      });
    }
    ...
    const rule = (0, _common.createCssRule)(mediaQuery, colorSchemeQuery, finalColorMode, dataHash, css, 'style', prefixClassName, prefixColorMode, hasState, themeCondition, themeCssObj);
