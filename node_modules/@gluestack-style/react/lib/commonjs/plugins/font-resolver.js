...
const tokenizeFontsConfig = function (styledObject) {
  let {
    fontsTokens,
    fontWeightsTokens
...
class FontResolver {
  ...
  register() {
    let styledUtils = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    if (this.styledUtils) {
  ...
  fontHandler() {
    ...
    let shouldUpdate = arguments.length > 1 ? arguments[1] : undefined;
    let fontStyleObject = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    ...
    for (const styledObjectKey in styledObject) {
      if (typeof styledObject[styledObjectKey] === 'object') {
        ...
        this.fontHandler(styledObject[styledObjectKey], shouldUpdate, fontStyleObject, keyPath);
        keyPath.pop();
      } else if (shouldUpdate) {
        if (styledObjectKey === 'fontFamily') {
          (0, _utils.setObjectKeyValue)(this.#fontFamily, [...keyPath, styledObjectKey], styledObject[styledObjectKey]);
  ...
  componentMiddleWare(_ref) {
    ...
    const OutputComponent = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
      ...
      const {
        variantProps,
        restProps
      } = (0, _styled.getVariantProps)(props, styledConfig, false);
      const variantStyledObject = resolveVariantFontsConfig(variantProps, styledConfig);
      let componentStyledObject = (0, _utils.deepMerge)(styledConfig, variantStyledObject);
