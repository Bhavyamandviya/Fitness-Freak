...
declare const _default: import("react").ForwardRefExoticComponent<Omit<Omit<import("react-native").ViewProps & {
    ...
    animationComponentGluestack: true;
}, "PopoverContent">> & Partial<import("@gluestack-style/react/lib/typescript/types").UtilityProps<import("react-native").StyleProp<import("react-native").ViewStyle>, unknown, import("react-native").ViewProps & {
    animationComponentGluestack: true;
}>> & {
    as?: any;
